...
f3=input('Enter the freq-3 in Hz:');
...
fs1=var1*fm;
n=0:1/fs1:0.2;
x1=cos(2*pi*f1*n)+cos(2*pi*f2*n)+cos(2*pi*f3*n);
figure(1);
subplot(3,3,1);
plot(t,x,'r')
xlabel('--->t');
...
fs2=var2*fm;
n=0:1/fs2:0.2;
x2=cos(2*pi*f1*n)+cos(2*pi*f2*n)+cos(2*pi*f3*n);
subplot(3,3,4);
plot(t,x,'r');
xlabel('--->t');
ylabel('Amp');
...
fs3=var3*fm;
n=0:1/fs3:0.2;
x3=cos(2*pi*f1*n)+cos(2*pi*f2*n)+cos(2*pi*f3*n);
subplot(3,3,7);
plot(t,x,'r')
xlabel('--->t');
ylabel('Amp');
